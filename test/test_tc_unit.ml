let () =
  ...
  let ir_with_queue = { empty_ir with queues = [
    { Lpf.Ir.name = "std";
      interface = { Lpf.Ir.name = Some "wan"; device = "eth0"; span = { Lpf.Policy.file = None; line = 1; column = 1; end_column = 1 } };
      bandwidth = "10M"; parent = None;
      span = { Lpf.Policy.file = None; line = 1; column = 1; end_column = 1 } }
  ]} in
  ...
  let ir_with_child = { empty_ir with queues = [
    { Lpf.Ir.name = "std";
      interface = { Lpf.Ir.name = Some "wan"; device = "eth0"; span = { Lpf.Policy.file = None; line = 1; column = 1; end_column = 1 } };
      bandwidth = "10M"; parent = None;
      span = { Lpf.Policy.file = None; line = 1; column = 1; end_column = 1 } };
    { Lpf.Ir.name = "voip";
      interface = { Lpf.Ir.name = Some "wan"; device = "eth0"; span = { Lpf.Policy.file = None; line = 2; column = 1; end_column = 1 } };
      bandwidth = "1M"; parent = Some "std";
      span = { Lpf.Policy.file = None; line = 2; column = 1; end_column = 1 } }
  ]} in
