...
|}
  ...
  | Ok json -> (
      ...
      | Ok policy -> (
          require
            (contains policy "Generated from Nomad job: web-server")
...
|}
          ...
          | Ok json -> (
              ...
              | Ok policy -> (
                  require
                    (contains policy "Generated from Nomad job: batch-job")
                    "policy contains header";
                  require
                    (contains policy "anchor nomad-worker")
...
|}
                  ...
                  | Ok json -> (
                      ...
                      | Ok policy ->
                          require
                            (contains policy "anchor nomad-api")
                            "policy contains api anchor";
                          require
                            (contains policy "anchor nomad-worker")
                            "policy contains worker anchor";
                          require
                            (contains policy "port 8080")
                            "policy contains port 8080";
                          require
                            (contains policy "port 50051")
                            "policy contains port 50051";
